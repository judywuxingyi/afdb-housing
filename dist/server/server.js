...
var app = express();
var PORT = 3000;
app.get('/', function (req, res) { return res.sendFile(path.join(__dirname, '../build/index.html')); });
var ApolloServerStart = function () { return __awaiter(void 0, void 0, void 0, function () {
